...
def having_ip_address(url):
    match=re.search('^([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\.([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\.([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\.([01]?\\d\\d?|2[0-4]\\d|25[0-5])$|0x[0-9A-F]{1,4}\.0x[0-9A-F]{1,4}\.0x[0-9A-F]{1,4}\.0x[0-9A-F]{1,4}',url)
...
#SHOULD NOT INCLUDE DOTS IN IP ADDRESS
    list=[x.start(0) for x in re.finditer('\.',url)]
    if len(list)<=3:
        return 1
    elif len(list)==4:
